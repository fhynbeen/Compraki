        ...
        <div class="ui middle aligned stackable grid container">
            <div class="row">
                <div class="eight wide column">
                    ...
                    <p>O objetivo nesse site é facilitar a vida das pessoas e fazer com que até as compras feitas no
                        mercado sejam mais fácil e viável, podendo agendar data de entrega, horário e mais.</p>
                    <h3 class="ui header">SOBRE O CURSO</h3>
                    <p>Eu só quero me formar logo pq eu não aguento mais</p>
                </div>
            ...
            <div class="row">
                <div class="center aligned column">
                    ...
                    <div>&nbsp;</div>
                    <div>&nbsp;</div>
                    <a href="#" class="ui huge button">Voltar ao topo</a>
                </div>
            </div>
        </div>
    </div>
