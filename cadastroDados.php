...
<div class="pusher">
    ...
    <form class="ui form" method="post" action="CRUDCompra.php?funcao=cadastro" style="margin-top: 2%;margin-left: 17%;width: 65%;background-color: #e0e0e0;padding-left: 1%;
	padding-top: 1%;
  padding-right: 1%;
  padding-bottom: 1%;
  margin-bottom: 5%;">
